...
#'     blue color gradient. The options are 'Node_Degree', 'Activity_Score', 'P_Value', and 'Z_Score'. A color 
...
#' @param bingroups Users can choose between 'Activity_Score',  'Node_Degree', 'P_Value', and 'Z_Score' to 
